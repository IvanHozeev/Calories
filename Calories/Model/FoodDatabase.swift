...
final class FoodItem: Identifiable {
    ...
    /// Строка встроенного каталога, из которой взяты витамины.
    ///
    /// Значения при этом скопированы, а не читаются по ссылке: иначе правка
    /// каталога молча меняла бы историю дневника задним числом. Идентификатор
